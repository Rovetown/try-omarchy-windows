...
func runClipboardBridge() {
	...
	go func() {
		for paths := range b.dropRequests {
			if err := b.offerDroppedFiles(paths); err != nil {
				b.transferError(err)
			}
		}
	}()
